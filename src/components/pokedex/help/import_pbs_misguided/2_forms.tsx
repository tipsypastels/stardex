      ...
      <ul class="mb-2">
        <li>
          <Checkbox
            name="All of them."
            radio
            checked={props.phase.formGranularity === "all"}
            onChange={() => props.phase.setFormGranularity("all")}
          />
        </li>
        <li>
          <Checkbox
            ...
            radio
            checked={props.phase.formGranularity === "types"}
            onChange={() => props.phase.setFormGranularity("types")}
          />
        </li>
        <li>
          <Checkbox
            ...
            radio
            checked={props.phase.formGranularity === "known"}
            onChange={() => props.phase.setFormGranularity("known")}
          />
        </li>
        <li>
          <Checkbox
            ...
            radio
            checked={props.phase.formGranularity === "custom"}
            onChange={() => props.phase.setFormGranularity("custom")}
          />
        </li>
      </ul>

      <Show
        when={props.phase.formGranularity === "custom"}
        fallback={
